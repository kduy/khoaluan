...
\include{1_timeseries/timeseries}	% background information
\include{2_ARIMA/ARIMA}						% aims of the project

\include{3_experiment/experiment}			
\include{4_conclusion/conclusion}	
